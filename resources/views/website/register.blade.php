    ...
    "
        ...
        <section class="container form-section">
            ...
            <form action="{{ route('register') }}" method="post" id="registerForm" enctype="multipart/form-data">
                ...
                <p id="registerSuccess" class="muted" style="display:none;color:#166534;font-weight:600;">Account
                    registered successfully. Redirecting to login...</p>
                <p id="registerError" class="muted" style="display:none;color:#b91c1c;font-weight:600;"></p>

                <p class="muted">Before registering you must accept the <a href="./terms.html">Terms & Conditions</a>.
                </p>
            </form>
        </section>
    </main>
    ...
    <script>
        ...
        registerForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                registerSuccess.textContent = body.message || 'Request submitted successfully. Waiting for approval...';
