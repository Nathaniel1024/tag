...
<head>
    ...
    <style>
        ...
        body.barangay-page .adm-sidebar,
        body.barangay-page .adm-sidebar-overlay,
        body.barangay-page .adm-menu-toggle {
            display: none !important;
        }

        body.barangay-page .adm-layout {
            display: block;
        }

        body.barangay-page .adm-main {
            width: 100%;
        }

        body.barangay-page .adm-topbar {
            justify-content: space-between;
            padding-left: 1rem;
            gap: 1rem;
        }

        .barangay-topbar-left,
        .barangay-topbar-right {
            display: flex;
            align-items: center;
            gap: .75rem;
            min-width: 0;
...
<body class="admin-dashboard barangay-page">
    <div class="adm-layout">
        ...
        <main class="adm-main">
            <header class="adm-topbar">
                <a class="back-to-dashboard" href="/dashboard" aria-label="Back to Admin Dashboard">
                            ...
                            <form id="createForm" class="barangay-form">
                                ...
                                <div class="barangay-grid">
                                    ...
                                    <div class="barangay-field">
                                        ...
                                        <input name="passwordConfirm" type="password" minlength="6"
