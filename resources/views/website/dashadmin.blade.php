...
<head>
    ...
    <style>
        ...
        .adm-page-actions .btn-add-official {
            display: inline-flex;
            align-items: center;
            gap: .55rem;
        ...
        .adm-page-actions .btn-add-official:hover {
...
<body class="admin-dashboard">
        ...
        <main class="adm-main">
            ...
            <section class="adm-content">
                ...
                <div class="adm-page-actions">
                    <a class="btn-add-official" href="/barangay" aria-label="Add Official">
    ...
    <div id="passwordModal" class="modal-overlay" hidden>
        <div class="modal" style="max-width:400px;">
            <button class="modal-close" id="passwordClose" type="button">âœ•</button>
            <div class="modal-header">
                <h2>Change Password</h2>
            </div>
            <div class="modal-body">
                <div style="margin-bottom:12px;color:#374151;font-size:14px;">Enter a new password for this account.
                </div>
                ...
                <input id="passwordConfirmInput" type="password" placeholder="Confirm new password"
                    style="width:100%;padding:10px;border:1px solid #ddd;border-radius:6px;margin-bottom:12px;" />
            ...
            try {
                ...
                if (!res.ok) {
                    document.querySelector('#staffTable tbody').innerHTML =
                        '<tr><td colspan="5" style="text-align:center;color:#c9302c">Failed to load staff accounts.</td></tr>';
                    return;
                }
                ...
                if (staff.length === 0) {
                    document.querySelector('#staffTable tbody').innerHTML =
                        '<tr><td colspan="5" style="text-align:center;color:#666">No staff accounts yet.</td></tr>';
                    return;
                }
